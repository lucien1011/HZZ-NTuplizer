...
i#cd EgammaAnalysis/ElectronTools/data
#git clone https://github.com/ECALELFS/ScalesSmearings.git -b Run2017_17Nov2017_v1
##cd ScalesSmearings/
...
git clone https://github.com/mhl0116/KinZfitter-1 KinZfitter
